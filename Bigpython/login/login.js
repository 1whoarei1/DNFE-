...
// Add this JavaScript code at the end of your HTML file or in a separate .js file

// Function to check scroll position and toggle class
function checkScroll() {
    const scrollY = window.scrollY || document.documentElement.scrollTop;

    if (scrollY > 100) { // Adjust the scroll position when the section should appear
